...
import { IoFilterOutline, IoRefreshOutline, IoAnalyticsOutline, IoListOutline, IoTimeOutline, IoCashOutline } from 'react-icons/io5';
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6 no-print">
            ...
            <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-gray-100">
                ...
                <div className="flex bg-gray-100 p-0.5 rounded-lg shadow-inner border border-gray-200">
                    ...
                    <button onClick={() => setViewMode('financial')} className={`flex items-center gap-1 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${viewMode === 'financial' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500'}`}><IoCashOutline/> Financeiro</button>
