...
export default function CartBar({ carrinho, finalOrderTotal, isWidgetOpen, coresEstabelecimento, onScrollToResumo }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 border-t border-gray-200 p-4 shadow-[0_-4px_20px_rgba(0,0,0,0.15)] z-[49] flex items-center justify-between animate-slide-up bg-white">
