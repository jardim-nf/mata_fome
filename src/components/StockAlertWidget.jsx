...
import { 
  ...
  IoCubeOutline, IoLayersOutline, IoChevronDownOutline
...
const StockAlertWidget = ({ estabelecimentoId, isDark = false }) => {
  ...
  return (
    <div className={`backdrop-blur-md rounded-3xl border p-5 sm:p-6 mb-8 relative shadow-lg transition-all duration-300 animate-in fade-in slide-in-from-top-4 ${
      ...
      {/* Título e ícone de Alerta — clicável para alternar recolhimento */}
      <div 
      ...
      {!isCollapsed && (
        <div className="mt-5 border-t border-slate-100 dark:border-slate-800 pt-4 animate-in fade-in duration-300">
          {/* Abas */}
          <div className="flex gap-2 mb-4 pb-2 overflow-x-auto hide-scrollbar">
            <button
