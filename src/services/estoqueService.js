...
export const estoqueService = {
   ...
   */
  async darBaixaEstoque(estabelecimentoIdPrincipal, itens) {
    console.log('🚨🚨🚨 [estoqueService] darBaixaEstoque CHAMADO!', { estabelecimentoIdPrincipal, qtdItens: itens?.length });
    
    if (!estabelecimentoIdPrincipal || !itens || itens.length === 0) {
    ...
    try {
      ...
      const result = await processarBaixaEstoque({ estabelecimentoId: estabelecimentoIdPrincipal, itens });
