        ...
        <div className="bg-white border-b border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center px-4 py-2 gap-4">
                <div className="flex items-center gap-3">
                    <button onClick={() => navigate('/admin')} className="p-2 border border-blue-200 hover:bg-blue-50 text-blue-600 cursor-pointer rounded-full transition-colors" title="Voltar ao início"><IoArrowBack size={20} /></button>
