  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] p-4 md:p-6 font-sans pb-24">
      <div className="max-w-7xl mx-auto">
        ...
        {/* 👇 MODAL 100% CORRIGIDO: CARD CENTRALIZADO COM ROLAGEM INTERNA PERFEITA 👇 */}
        {showItemForm && (
            <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-2 sm:p-6 transition-opacity">
                
                {/* O Formulário agora é um CARD. 
                    max-h-[95vh] limita a altura. 
                    flex flex-col permite que o meio role enquanto topo e rodapé ficam fixos. */}
                <form 
                    onSubmit={handleSaveItem} 
                    className="bg-white w-full max-w-5xl max-h-[95vh] sm:max-h-[90vh] flex flex-col rounded-2xl sm:rounded-3xl shadow-2xl relative overflow-hidden animate-slide-up"
                >
                    
                    {/* 1. CABEÇALHO TRAVADO (Não rola, flex-none) */}
                    <div className="flex-none px-5 py-4 sm:px-8 sm:py-6 border-b border-gray-100 flex items-center justify-between bg-white z-20">
                        <div>
                        ...
                        <button 
                            ...
                            className="p-2 sm:p-3 bg-gray-50 hover:bg-red-50 text-gray-500 hover:text-red-500 rounded-full transition-colors"
                        >
                            <IoClose size={24} />
                        </button>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-8 bg-gray-50/50">
                        <div className="space-y-6 sm:space-y-8 w-full max-w-4xl mx-auto">
                            
                            {/* Bloco 1: Nome, Categoria, etc */}
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 bg-white p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm">
                            ...
                            <div className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3">
                                    <h3 className="font-bold text-gray-800 flex items-center gap-2 text-base sm:text-lg"><IoCash className="text-blue-600 text-xl"/> Precificação e Estoque</h3>
                                    ...
                                    {variacoes.map((v, idx) => (
                                        <div key={v.id} className="bg-gray-50 p-4 sm:p-5 rounded-xl border border-gray-200 relative group">
                                            ...
                                            <div className="grid grid-cols-12 gap-3 sm:gap-4">
                                                ...
                                                <div className="col-span-12 flex items-center justify-between sm:justify-end mt-2 pt-4 border-t border-gray-200 border-dashed">
                            ...
                            {/* Bloco 3: Fiscal */}
                            <div className="bg-emerald-50/50 p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-emerald-100 shadow-sm">
                                <h3 className="font-bold text-emerald-800 mb-4 flex items-center gap-2 text-base sm:text-lg">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
                                <div className="flex-1 flex gap-4 items-center bg-white p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm">
                                     <div className="w-20 h-20 bg-gray-50 rounded-xl border border-gray-200 flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                                ...
                                <div className="sm:w-1/3 bg-blue-50 p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-blue-100 flex items-center justify-center shadow-sm">
                                    <label htmlFor="ativoMain" className="flex items-center justify-between sm:justify-center gap-3 cursor-pointer w-full">
                                        <div className="flex flex-col sm:text-right">
                                            ...
                                            <span className="text-[10px] sm:text-xs font-medium text-gray-500 mt-0.5">{formData.ativo ? 'Visível aos clientes' : 'Oculto do App'}</span>
                                        </div>
                    ...
                    {/* 3. RODAPÉ TRAVADO FIXO NO FUNDO (flex-none não deixa o botão sumir) */}
                    <div className="flex-none bg-white border-t border-gray-100 p-4 sm:p-6 flex justify-end gap-3 sm:gap-4 z-20 shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
                        <button 
                            type="button" 
                            onClick={closeItemForm} 
                            className="hidden sm:block px-8 py-3.5 bg-gray-100 border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-colors text-base"
                        >
                            Cancelar
                        </button>
                        ...
                        <button 
                            ...
                            className="w-full sm:w-auto px-10 py-3.5 sm:py-4 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-xl shadow-blue-200 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:scale-100 text-base sm:text-lg flex justify-center items-center gap-2"
                        >
                            {formLoading ? 'Salvando...' : <><IoCheckmarkCircle size={22}/> Salvar Produto</>}
                        </button>
                    </div>
