    ...
    <div className="min-h-screen bg-[var(--bege-claro)] p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8 md:p-12">
        <h1 className="text-4xl font-extrabold text-center text-[var(--vermelho-principal)] mb-10">
          Planos e Funcionalidades do Mata Fome
        </h1>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            O Mata Fome é a plataforma perfeita para restaurantes, lanchonetes e bares que desejam digitalizar seus pedidos e otimizar a gestão. Com nossa solução, você oferece uma experiência de pedido online intuitiva para seus clientes e centraliza todas as informações em um painel de controle fácil de usar.
          </p>
