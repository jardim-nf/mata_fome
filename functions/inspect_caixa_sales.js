...
async function run() {
  ...
  // Let's use the opening time of the open cashier jzup5KIkHpbfoESGw0fk
  const shiftOpenTime = new Date('2026-06-20T20:57:47.250Z');
  ...
  console.log(`Total sales in DB: ${snapshot.size}`);
  ...
  snapshot.forEach(doc => {
    ...
    if (parsedDate.getTime() >= (shiftOpenTime.getTime() - 60000)) {
      ...
      // Let's print each sale to see the details
  ...
  console.log(`\nTotal sales since shift open: ${count}`);
  console.log("\n--- AGGREGATED TOTALS ---");
