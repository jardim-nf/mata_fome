...
async function run() {
  ...
  // Financial day range for June 20
  const start = new Date('2026-06-20T09:00:00.000Z');
  const end = new Date('2026-06-21T08:59:59.999Z');
  
  console.log(`Analyzing financial day of June 20, 2026...`);
  ...
  console.log(`\n=== FINANCIAL DAY TOTALS ===`);
  console.log(`Orders count: ${count}`);
  console.log(`Total faturado: R$ ${total.toFixed(2)}`);
  console.log(`Payment methods:`, paymentMethodsTotal);
}
